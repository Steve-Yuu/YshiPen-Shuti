...
本字體命名原本計劃以本人筆名“鬰”或者“Yuu”命名，但是由於“鬰”難以辨識，並且“Yuu”可能會與其他字體名稱撞車，因此直接以“Y式”（又稱YShi）命名，“Y”其實是“鬰”拼音的第一個字母，也是筆名“Yuu”的第一個字母。字體於2024.7.20之前，名曰“YShi書體”，由於“書體”在日本語意思是“字體”的意思，爲防止歧義故更改，本計畫更名“楷書體”，由於他人有更好的建議，故更名“筆書”
...
- 這款字體可以自由傳播、分享，或者將字體安裝於系統、軟體或 APP 中也是允許的，可以與任何軟體捆綁再分發以及／或一并銷售。
- 這款字體可以自由修改、改造，製作衍生字體。修改或改造後的字體也必須同樣以 [SIL OFL 1.1](https://scripts.sil.org/OFL) 公開。
- 根據 [SIL Open Font License 1.1](https://scripts.sil.org/OFL) 許可與條件中第一條的規定， 禁止單獨出售字體檔(OTF/TTF 檔)的行爲。
...
- 本字體不嚴格遵循《傳承字體檢校表》推薦寫法，而是對其進行取捨
- 本字體異體版少許借用碑帖中的某些異體字
- 本字體目前不計劃做等寬（MONO）
- 本字體目前只有標點居中版
...
或「YShiPen-Shuti」。
- 關於各種尾碼的含義：CL（傳統舊字形）、CLS（傳統舊字形變體）、TC（舊字形，摻雜港台常用字形）、新筆書（折中舊字形，摻雜G標習慣字形）
若有問題，歡迎在issue進行回饋
